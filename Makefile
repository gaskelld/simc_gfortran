...
OBJ1	= target.o brem.o gauss1.o NtupleInit.o NtupleClose.o enerloss_new.o nuclear_elastic.o
OBJ2	= radc.o init.o dbase.o physics_kaon.o physics_pion.o physics_dvcs.o physics_delta.o physics_proton.o loren.o sf_lookup.o
